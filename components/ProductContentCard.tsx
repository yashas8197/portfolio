...
const ProductContentCard = ({ product }: { product: Product }) => {
  return (
    <div className="group bg-white rounded-2xl p-8 md:p-10 border border-slate-200 hover:border-slate-300 shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <div>
          ...
          <ul className="space-y-3 mb-8">
            {product.outcomes.map((item, i) => (
              <li
                key={i}
                className="flex items-start text-sm font-medium text-slate-700 leading-relaxed"
              >
